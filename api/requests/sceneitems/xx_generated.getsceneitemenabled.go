...
func (o *GetSceneItemEnabledParams) WithCanvasName(x string) *GetSceneItemEnabledParams {
	o.CanvasName = &x
	return o
}
func (o *GetSceneItemEnabledParams) WithCanvasUuid(x string) *GetSceneItemEnabledParams {
	o.CanvasUuid = &x
	return o
}
