...
func (o *GetSceneItemListParams) WithCanvasName(x string) *GetSceneItemListParams {
	o.CanvasName = &x
	return o
}
func (o *GetSceneItemListParams) WithCanvasUuid(x string) *GetSceneItemListParams {
	o.CanvasUuid = &x
	return o
}
