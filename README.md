...
[protocol-img]: https://img.shields.io/badge/obs--websocket-v5.7.0-blue?logo=obs-studio&style=flat-square
[protocol-url]: https://github.com/obsproject/obs-websocket/blob/5.7.0/docs/generated/protocol.md
...
Client protocol version: 5.7.0
Client library version: 1.8.0
```
[//]: # (snippet-2-end)
