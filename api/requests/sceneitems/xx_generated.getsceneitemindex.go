...
func (o *GetSceneItemIndexParams) WithCanvasName(x string) *GetSceneItemIndexParams {
	o.CanvasName = &x
	return o
}
func (o *GetSceneItemIndexParams) WithCanvasUuid(x string) *GetSceneItemIndexParams {
	o.CanvasUuid = &x
	return o
}
