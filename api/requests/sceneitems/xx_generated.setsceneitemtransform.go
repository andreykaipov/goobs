...
func (o *SetSceneItemTransformParams) WithCanvasName(x string) *SetSceneItemTransformParams {
	o.CanvasName = &x
	return o
}
func (o *SetSceneItemTransformParams) WithCanvasUuid(x string) *SetSceneItemTransformParams {
	o.CanvasUuid = &x
	return o
}
