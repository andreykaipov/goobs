...
e2e:
	...
	@docker run --rm --detach --name goobs-e2e -p 4545:4444 ghcr.io/andreykaipov/goobs >/dev/null
	@sleep 1 # lol
...
generate:
	cd internal; go run ./protocol/
	go install github.com/segmentio/golines@latest
	golines --shorten-comments --max-len=120 --reformat-tags --write-output api
